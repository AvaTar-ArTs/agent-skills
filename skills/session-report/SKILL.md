---
name: session-report
description: Generate an explorable HTML report of Codex session usage (tokens, cache, subagents, skills, expensive prompts) from ~/.Codex/projects transcripts.
---

# Session Report

Produce a self-contained HTML report of Codex usage and save it to the current working directory.
