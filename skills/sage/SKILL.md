...
5. Choose the best specialist agents from `/Users/steven/.agent-skills/agents`.
...
- Use `/Users/steven/.agent-skills` as canonical; treat `/Users/steven/.agents` as compatibility only.
