...
class PathService:
    ...
    def __init__(self, workspace_root: Path | None = None):
        ...
        runtime_root = os.environ.get("DEEPTUTOR_DATA_ROOT")
        default_root = Path(runtime_root).expanduser() if runtime_root else self._project_root / "data"
        self._workspace_root = (workspace_root or default_root).resolve()
